...
const Skills = () => {
    return (
        <motion.div
            initial={{ opacity: 0, y:5 }} //Animação de entrada
        ...
        >
            <div className='container mx-auto px-6'>
                ...
                <p className='text-gray-400 text-center max-w-2xl mx-auto mb-16'>
                    Technologies, skills, and knowledge
                </p>
                        ...
                        skills.map((skill, index)=>(
                            <div key={index} className='bg-dark-300 rounded-2xl p-6 hover:-translate-y-2 transition duration-300 cursor-pointer'>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    {skill.tags.map((tech) => (
                                        <span key={tech} className="px-3 py-1 bg-dark-400 rounded-full text-sm text-center">
                                        {tech}
                                        </span>
                                    ))}
                                </div>
